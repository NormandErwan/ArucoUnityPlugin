#ifndef __ARUCO_UNITY_PLUGIN_BOARD_HPP__
#define __ARUCO_UNITY_PLUGIN_BOARD_HPP__
...
//!
//! See the OpenCV documentation for more information: http://docs.opencv.org/3.4.7/d4/db2/classcv_1_1aruco_1_1Board.html
//! @{
