...
extern "C" {
  ...
  //! \brief Converts a rotation vector to a a rotation matrix.
  //! \param src Input rotation vector (3x1 or 1x3).
  //! \param dst Output rotation matrix (3x3).
  //! \param exception The first exception threw by any trigerred CV_ASSERT.
  //!
  //! See the OpenCV documentation for more information:
  ...
  //! \param src Input rotation matrix (3x3).
  //! \param dst Output rotation vector (3x1 or 1x3).
  //! \param exception The first exception threw by any trigerred CV_ASSERT.
  //!
  //! See the OpenCV documentation for more information:
  //! http://docs.opencv.org/3.4.7/d9/d0c/group__calib3d.html#ga61585db663d9da06b68e70cfbf6a1eac
  ...
  //! \param rotationMatrix Output rotation matrix between the 1st and the 2nd camera coordinate systems.
  ...
  //! \param rotationMatrix Rotation matrix between the coordinate systems of the first and the second cameras.
  ...
  //! \param scalingFactor Free scaling parameter between 0 (when all the pixels in the undistorted image are valid) and 1 (when all the source image
  ...
  //! \param validPixROI Optional output rectangle that outlines all-good-pixels region in the undistorted image.
  //! \param centerPrincipalPoint Optional flag that indicates whether in the new camera matrix the principal point should be at the image center or not.
  //! \param exception The first exception threw by any trigerred CV_ASSERT.
